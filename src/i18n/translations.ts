...
export const translations = {
  en: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: 'ResidencyOS transformed what felt like an overwhelming process into something manageable. The deadline reminders alone saved me from missing a critical renewal.',
          author: 'Maria Santos',
          role: 'Work Visa Holder',
          location: 'Brazil to USA',
        },
        {
          quote: 'As an immigration attorney, I recommend ResidencyOS to all my clients. It keeps them organized and reduces the back-and-forth significantly.',
          author: 'James Chen',
          role: 'Immigration Attorney',
          location: 'Los Angeles, CA',
        },
        {
          quote: 'The document management feature is incredible. Everything is organized, encrypted, and accessible when I need it. Worth every penny.',
          author: 'Priya Sharma',
    ...
    footer: {
      ...
      copyright: '© 2024 ResidencyOS. All rights reserved.',
  ...
  es: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: 'ResidencyOS transformó lo que parecía un proceso abrumador en algo manejable. Solo los recordatorios de fechas me salvaron de perder una renovación crítica.',
          author: 'María Santos',
          role: 'Titular de Visa de Trabajo',
          location: 'Brasil a EE.UU.',
        },
        {
          quote: 'Como abogado de inmigración, recomiendo ResidencyOS a todos mis clientes. Los mantiene organizados y reduce significativamente la comunicación innecesaria.',
          author: 'James Chen',
          role: 'Abogado de Inmigración',
          location: 'Los Ángeles, CA',
        },
        {
          quote: 'La función de gestión de documentos es increíble. Todo está organizado, encriptado y accesible cuando lo necesito. Vale cada centavo.',
          author: 'Priya Sharma',
          role: 'Solicitante de Visa de Estudiante',
          location: 'India a Canadá',
        },
      ],
    },
    ...
    footer: {
      ...
      copyright: '© 2024 ResidencyOS. Todos los derechos reservados.',
